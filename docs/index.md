...
### ネットワーク
- [mDNSサーバー](./tech/network/mdns.md)
- [UniFi Endpoint](./tech/network/unifi-endpoint.md)
- [WireGuard](./tech/network/wireguard.md)
### デバイス
- [プリンタ](./tech/devices/printer.md)
- [メモリのスワップ](./tech/devices/memory-swap.md)
### VM/コンテナ/互換レイヤ
- [Docker](./tech/virtualization/docker.md)
- [Devcontainer CLI](./tech/virtualization/devcontainer-cli.md)
- [Windows 互換レイヤ](./tech/virtualization/wine.md)
### パッケージマネージャ
...
- [Google 日本語入力](./tech/apps/google-japaneseime.md)
- [OBS Studio](./tech/apps/obs-studio.md)
### UI
